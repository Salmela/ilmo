...
if env("LOCAL") == 'False':
    urlpatterns = [
        ...
        path("returned_report/<int:report_id>/<int:limit>", views.returned_report, name="returned_report"),
        path("evaluate_report/<int:report_id>", views.evaluate_report, name="evaluate_report"),
        path("evaluate_report/<int:report_id>/<int:limit>", views.evaluate_report, name="evaluate_report"),
