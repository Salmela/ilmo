...
def check_and_replace(request, prev_1, prev_2, prev_3, prev_4, student, lab_group, file):
    ...
    if prev_3:
        ...
        report = Report(student=student, lab_group=lab_group, filename=file, report_name=file.name, report_status=3)
        report.save()
    ...
    if prev_1:
        ...
        report = Report(student=student, lab_group=lab_group, filename=file, report_name=file.name, report_status=1)
        report.save()
