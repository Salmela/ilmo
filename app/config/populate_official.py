...
with open('config/test_data_1.csv') as file:
    for line in file:
        ...
        parts = line.split(';')
        try:
            user = User.objects.get(username=parts[1])
...
"""
with open('config/test_data_5.csv') as file:
    for line in file:
        line = line.replace('\n','')
        parts = line.split(';')
...
"""
with open('config/test_data_6.csv') as file:
    for line in file:
        line = line.replace('\n','')
        parts = line.split(';')
...
"""
with open('config/test_data_7.csv') as file:
    for line in file:
        line = line.replace('\n','')
        parts = line.split(';')
